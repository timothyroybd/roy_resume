      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            courses to educate the team on effective online security practices.
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul>
          ...
          <li>
            Integrating and experimenting with different 3rd party web Apis such
            Image processing though Nanonets platform
          </li>
